    ...
    <div className="max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100">
        ...
        <div className="space-y-3">
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-xl font-medium text-gray-700 hover:bg-gray-50 transition-colors"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            Não tem uma conta?{" "}
            <Link to="/cadastro" className="text-blue-600 font-semibold hover:text-blue-700 hover:underline">
              Criar conta
            </Link>
          </p>
        </div>
